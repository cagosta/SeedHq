...
requirejs.config( {
    ...
    paths: {
        engineDetector: '.',
        ifEngineIsNode: 'engineDetector/ifEngineIsNode',
        ifEngineIsBrowser: 'engineDetector/ifEngineIsBrowser',
        fakeWindowOnNode: 'engineDetector/fakeWindowOnNode',
...
if ( synchronous ) { // case standalone
    ...
    var engineDetector = requirejs( 'engineDetector/engineDetector' )
    ...
    requirejs( [ 'engineDetector/engineDetector' ], function( engineDetector ) {
        engine.exports( 'engineDetector', engineDetector )
    } )

}
;
define("engineDetector/main", function(){});
}());