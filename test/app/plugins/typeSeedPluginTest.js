define( [
    ...
    var baseInheritenceTests = function( Extendable ) {

        describe( 'basic inheritence', function() {
    ...
    describe( 'Seed plugin', function() {

        describe( ' before extension', function() {

            var Extendable = Seed

            describe( 'basic Extendandable', function() {

                baseInheritenceTests( Extendable )
